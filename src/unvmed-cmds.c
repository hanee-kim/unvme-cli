...
int unvme_log_level(int argc, char *argv[], struct unvme_msg *msg)
{
	const char *desc =
		...
		"arrive faster than the logger can write them out, the excess is\n"
		"dropped so that I/O is never held up.  --lossless=1 reverses\n"
		"that: nothing is dropped, and a submission waits when the log\n"
		"falls behind.";
